...
noise_levels = [0.4, 0.5]

def run_experiment_with_noise(X, y, gamma, v, noise_levels):
    ...
    for noise_level in noise_levels:
        ...
        print(f'添加{int(noise_level*100)}%高斯噪声后的平均分类准确率: {np.mean(accuracies):.4f}')

fixed_gamma = 0.1
fixed_v = 0.5
run_experiment_with_noise(X, y, fixed_gamma, fixed_v, noise_levels)
